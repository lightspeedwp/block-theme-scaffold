...
- [accessibility.instructions.md](accessibility.instructions.md) — Accessibility standards (WCAG 2.2 AA) for patterns, templates, and parts
- [wpcs-php.instructions.md](wpcs-php.instructions.md) — PHP coding standards (formatting, naming, security, i18n)
- [javascript.instructions.md](javascript.instructions.md) — JavaScript, React, and JSDoc standards
- [wpcs-css.instructions.md](wpcs-css.instructions.md) — CSS/SCSS coding standards (naming, specificity, formatting)
- [html-markup.instructions.md](html-markup.instructions.md) — HTML markup and template standards

**Additional Resources:**

- [theme-json.instructions.md](theme-json.instructions.md) — Theme.json configuration and design systems
- [security-nonce.instructions.md](security-nonce.instructions.md) — WordPress nonce implementation patterns
- [naming-conventions.instructions.md](naming-conventions.instructions.md) — File and code naming standards
- [reporting.instructions.md](reporting.instructions.md) — Report generation and management
...
- **Directories:**
  ...
  - `parts/` — Reusable template parts (e.g., `header.html`, `footer.html`, `sidebar.html`).
    - Valid block comments required in all part files
  - `patterns/` — Block patterns (PHP or JSON files with header metadata and block markup).
  ...
  - `styles/` — Style variations as JSON files that override `theme.json`.
    - Used for dark mode, custom color schemes, or design variations
    - Each file should be a valid `theme.json` style configuration
  - `assets/` (or `src/`) — Source files for SCSS, JS, images, fonts, SVGs, etc.
...
- ✅ Valid block comments in all templates and parts
- ✅ Pattern files include required metadata headers (Title, Slug, Categories)
- ✅ Pattern slug follows format: `namespace/category-name`
- ✅ Patterns include optional but recommended Keywords and Viewport Width
- ✅ All source files properly organized (never mix source and build output)
