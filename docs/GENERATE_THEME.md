...
See [theme-config.template.json](../scripts/fixtures/theme-config.template.json) for full schema and [.github/schemas/theme-config.schema.json](../.github/schemas/theme-config.schema.json) for JSON Schema validation details.
