...
const questions = [
	// Mode selection: validation or full release
	{
		type: 'list',
		name: 'releaseMode',
		...
		choices: [
			{
				name: 'Pre-release validation (lint, test, dry-run only)',
				value: 'validation',
			},
			{
				name: 'Full release (includes validation and release steps)',
				value: 'release',
			},
		],
		default: 'validation',
	...
	// Placeholder integrity check
	{
		...
		message:
			'Run placeholder integrity check (scan for PLACEHOLDER tokens)?',
		default: true,
	},
	// Meta version alignment
	{
		...
		message:
			'Check meta version alignment (VERSION, package.json, composer.json)?',
		default: true,
	},
	// Schema validation
	{
	...
	// Release template sanity
	{
		...
		message:
			'Check release template sanity (placeholders in agent/prompt/docs)?',
		default: true,
	},
	// Quality gates
	{
	...
	// Generation smoke test
	{
		...
		name: 'runSmokeTest',
		message:
			'Run generation smoke test (generate sample theme and check output)?',
		default: true,
	},
