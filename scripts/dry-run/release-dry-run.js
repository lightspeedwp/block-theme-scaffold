...
const AGENT_TARGETS = {
	...
	scaffold: path.resolve(
		...
		'..',
		'agents',
		'release-scaffold.agent.js'
	),
};

function printUsage() {
	console.log(
		'Usage: node scripts/dry-run/release-dry-run.js <release|scaffold> [agent arguments]'
	);
	console.log(
		'Example: node scripts/dry-run/release-dry-run.js release validate'
	);
