...
- **scaffold-generator.agent.js** - Interactive theme scaffold generator
...
### scaffold-generator.agent.test.js
...
```javascript
const { validateValue, validateConfig } = require('../scaffold-generator.agent');
