 ...
 *
 * Usage:
 *   node scripts/validation/validate-theme-config.js [config-file]
 *   node scripts/validation/validate-theme-config.js --schema-only
 *   node scripts/validation/validate-theme-config.js --help
 *
 * @package
 */
...
Examples:
  ...
  node scripts/validation/validate-theme-config.js .github/schemas/plugin-config.example.json

  # Validate custom configuration
  node scripts/validation/validate-theme-config.js my-plugin-config.json
