...
const EXAMPLE_VALIDATIONS = [
  {
    ...
    examplePath: path.join(__dirname, '../../.github/schemas/examples/theme-config.example.json'),
    schemaPath: path.join(__dirname, '../../.github/schemas/theme-config.schema.json'),
  },
  {
    name: 'theme-config.template.json',
    examplePath: path.join(__dirname, '../../scripts/fixtures/theme-config.template.json'),
    schemaPath: path.join(__dirname, '../../.github/schemas/theme-config.schema.json'),
  },
  {
    name: 'agency-pro.config.json',
    examplePath: path.join(__dirname, '../../.github/schemas/examples/agency-pro.config.json'),
    schemaPath: path.join(__dirname, '../../.github/schemas/theme-config.schema.json'),
  },
  {
    name: 'ecommerce-hub.config.json',
    examplePath: path.join(__dirname, '../../.github/schemas/examples/ecommerce-hub.config.json'),
    schemaPath: path.join(__dirname, '../../.github/schemas/theme-config.schema.json'),
  },
  {
    name: 'blog-pro.config.json',
    examplePath: path.join(__dirname, '../../.github/schemas/examples/blog-pro.config.json'),
    schemaPath: path.join(__dirname, '../../.github/schemas/theme-config.schema.json'),
  },
  {
    name: 'tour-operator.config.json',
    examplePath: path.join(__dirname, '../../.github/schemas/examples/tour-operator.config.json'),
    schemaPath: path.join(__dirname, '../../.github/schemas/theme-config.schema.json'),
  },
];
