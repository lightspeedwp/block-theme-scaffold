<?php
/**
 * Block patterns registration for Block Theme Scaffold
 *
 ...
 */
function block-theme-scaffold_register_hero_pattern() {
	register_block_pattern(
		'block-theme-scaffold/hero-section',
		array(
			'title'       => __( 'Hero Section', 'block-theme-scaffold' ),
			'description' => __( 'A large hero section with heading, text, and button.', 'block-theme-scaffold' ),
			'categories'  => array( 'block-theme-scaffold-hero' ),
...
add_action( 'init', 'block-theme-scaffold_register_hero_pattern' );

/**
 * Register call to action pattern.
 */
function block-theme-scaffold_register_cta_pattern() {
	register_block_pattern(
		'block-theme-scaffold/call-to-action',
		array(
			'title'       => __( 'Call to Action', 'block-theme-scaffold' ),
			'description' => __( 'A call to action section with heading and button.', 'block-theme-scaffold' ),
			'categories'  => array( 'block-theme-scaffold-cta' ),
...
add_action( 'init', 'block-theme-scaffold_register_cta_pattern' );

/**
 * Register team section pattern.
 */
function block-theme-scaffold_register_team_pattern() {
	register_block_pattern(
		'block-theme-scaffold/team-section',
		array(
			'title'       => __( 'Team Section', 'block-theme-scaffold' ),
			'description' => __( 'A team section with multiple team member cards.', 'block-theme-scaffold' ),
			'categories'  => array( 'block-theme-scaffold-team' ),
...
add_action( 'init', 'block-theme-scaffold_register_team_pattern' );