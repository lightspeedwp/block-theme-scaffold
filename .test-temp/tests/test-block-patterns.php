...
class Test_Block_Patterns extends WP_UnitTestCase {
	...
	public function set_up() {
		...
		foreach ( $registry->get_all_registered() as $pattern ) {
			if ( strpos( $pattern['name'], 'block-theme-scaffold/' ) === 0 ) {
	...
	public function test_hero_pattern_function_exists() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_register_hero_pattern' ),
	...
	public function test_cta_pattern_function_exists() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_register_cta_pattern' ),
	...
	public function test_team_pattern_function_exists() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_register_team_pattern' ),
	...
	public function test_hero_pattern_registered() {
		try {
			...
			$registry = WP_Block_Patterns_Registry::get_instance();
			$pattern = $registry->get_registered( 'block-theme-scaffold/hero-section' );
	...
	public function test_cta_pattern_registered() {
		try {
			...
			$registry = WP_Block_Patterns_Registry::get_instance();
			$pattern = $registry->get_registered( 'block-theme-scaffold/call-to-action' );
	...
	public function test_team_pattern_registered() {
		try {
			...
			$registry = WP_Block_Patterns_Registry::get_instance();
			$pattern = $registry->get_registered( 'block-theme-scaffold/team-section' );
	...
	public function test_pattern_categories() {
		try {
			...
			$registry = WP_Block_Patterns_Registry::get_instance();
			$hero = $registry->get_registered( 'block-theme-scaffold/hero-section' );
			...
			$this->assertContains( 'block-theme-scaffold-hero', $hero['categories'] );
		} catch ( Exception $e ) {
