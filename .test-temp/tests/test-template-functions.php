...
class Test_Template_Functions extends WP_UnitTestCase {
	...
	public function test_get_version_function_exists() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_get_version' ),
	...
	public function test_get_version_returns_string() {
		try {
			$version = block-theme-scaffold_get_version();
	...
	public function test_get_theme_mod_wrapper() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_get_theme_mod' ),
			'Get theme mod wrapper should exist'
		);

		try {
			set_theme_mod( 'block-theme-scaffold_test', 'test_value' );
			$value = block-theme-scaffold_get_theme_mod( 'test', 'default' );

			$this->assertEquals( 'test_value', $value, 'Should return theme mod value' );

			// Clean up
			remove_theme_mod( 'block-theme-scaffold_test' );
		} catch ( Exception $e ) {
	...
	public function test_footer_text_function() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_footer_text' ),
			'Footer text function should exist'
		);

		try {
			set_theme_mod( 'block-theme-scaffold_footer_text', 'Test Footer' );

			ob_start();
			block-theme-scaffold_footer_text();
			$output = ob_get_clean();

			$this->assertEquals( 'Test Footer', $output, 'Should output footer text' );

			// Clean up
			remove_theme_mod( 'block-theme-scaffold_footer_text' );
		} catch ( Exception $e ) {
	...
	public function test_show_social_links() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_show_social_links' ),
			'Show social links function should exist'
		);

		try {
			set_theme_mod( 'block-theme-scaffold_show_social_links', false );
			$this->assertFalse( block-theme-scaffold_show_social_links() );

			set_theme_mod( 'block-theme-scaffold_show_social_links', true );
			$this->assertTrue( block-theme-scaffold_show_social_links() );

			// Clean up
			remove_theme_mod( 'block-theme-scaffold_show_social_links' );
		} catch ( Exception $e ) {
	...
	public function test_header_layout_class() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_get_header_layout_class' ),
			'Get header layout class function should exist'
		);

		try {
			set_theme_mod( 'block-theme-scaffold_header_layout', 'centered' );
			$class = block-theme-scaffold_get_header_layout_class();

			$this->assertEquals( 'header-layout-centered', $class, 'Should return correct class name' );

			// Clean up
			remove_theme_mod( 'block-theme-scaffold_header_layout' );
		} catch ( Exception $e ) {
	...
	public function test_body_classes_filter() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_body_classes' ),
			'Body classes function should exist'
		);

		try {
			$classes = block-theme-scaffold_body_classes( [] );
			...
			foreach ( $classes as $class ) {
				if ( strpos( $class, 'block-theme-scaffold-version-' ) === 0 ) {
	...
	public function test_viewport_meta_function_exists() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_viewport_meta' ),
	...
	public function test_custom_logo_setup_exists() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_custom_logo_setup' ),
	...
	public function test_editor_color_palette_exists() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_editor_color_palette' ),
	...
	public function test_custom_excerpt_length() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_custom_excerpt_length' ),
		...
		try {
			...
			$length = block-theme-scaffold_custom_excerpt_length( 55 );
	...
	public function test_remove_version() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_remove_version' ),
			'Remove version function should exist'
		);

		try {
			$result = block-theme-scaffold_remove_version();
	...
	public function test_security_headers_function_exists() {
		$this->assertTrue(
			function_exists( 'block-theme-scaffold_security_headers' ),
