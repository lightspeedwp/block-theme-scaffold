...
class Test_Theme_Setup extends WP_UnitTestCase {
	...
	public function test_theme_setup_function_exists() {
		$this->assertTrue( function_exists( 'block-theme-scaffold_setup' ) );
	}
	...
	public function test_theme_includes() {
		$this->assertTrue( function_exists( 'block-theme-scaffold_register_pattern_categories' ) );
		$this->assertTrue( function_exists( 'block-theme-scaffold_enqueue_assets' ) );
		$this->assertTrue( function_exists( 'block-theme-scaffold_enqueue_editor_assets' ) );
	}
	...
	public function test_block_pattern_categories() {
		...
		$theme_categories = array_filter( $categories, function( $category ) {
			return strpos( $category['name'], 'block-theme-scaffold-' ) === 0;
		});
