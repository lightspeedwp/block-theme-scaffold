...
/**
 * Title: Footer
 * Slug: block-theme-scaffold/footer
...
$quick_links_title = esc_html__( 'Quick Links', 'block-theme-scaffold' );
$follow_us_title   = esc_html__( 'Follow Us', 'block-theme-scaffold' );
$privacy_link      = esc_html__( 'Privacy Policy', 'block-theme-scaffold' );
$terms_link        = esc_html__( 'Terms of Service', 'block-theme-scaffold' );
$copyright_text    = sprintf(
	/* translators: %s: current year */
	esc_html__( '© %s All rights reserved.', 'block-theme-scaffold' ),
	gmdate( 'Y' )
);
?>
...
<footer class="wp-block-group has-neutral-background-color has-background" style="margin-top:var(--wp--preset--spacing--60);padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)" role="contentinfo">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group">
			...
			<ul class="wp-block-social-links has-icon-color is-style-logos-only" aria-label="<?php esc_attr_e( 'Social media links', 'block-theme-scaffold' ); ?>">
	...
	<div class="wp-block-group alignwide">
		...
		<p class="has-small-font-size">
			...
			printf(
				...
				esc_html__( 'Proudly powered by %s', 'block-theme-scaffold' ),
				'<a href="' . esc_url( __( 'https://wordpress.org', 'block-theme-scaffold' ) ) . '" rel="nofollow">WordPress</a>'
			);
			?>
		</p>
		<!-- /wp:paragraph -->
