...
/**
 * Title: Testimonials
 * Slug: block-theme-scaffold/testimonials
...
$section_title = esc_html__( 'What Our Customers Say', 'block-theme-scaffold' );

$testimonial_1_text   = esc_html__( '"This product has completely transformed how we work. The efficiency gains have been incredible and the support team is always there when we need them."', 'block-theme-scaffold' );
$testimonial_1_author = esc_html__( 'Jane Smith', 'block-theme-scaffold' );
$testimonial_1_role   = esc_html__( 'CEO, Tech Company', 'block-theme-scaffold' );

$testimonial_2_text   = esc_html__( '"I was skeptical at first, but after just one month of use, I became a believer. The results speak for themselves."', 'block-theme-scaffold' );
$testimonial_2_author = esc_html__( 'John Doe', 'block-theme-scaffold' );
$testimonial_2_role   = esc_html__( 'Marketing Director', 'block-theme-scaffold' );

$testimonial_3_text   = esc_html__( '"Outstanding quality and exceptional customer service. This is exactly what we were looking for to take our business to the next level."', 'block-theme-scaffold' );
$testimonial_3_author = esc_html__( 'Sarah Johnson', 'block-theme-scaffold' );
$testimonial_3_role   = esc_html__( 'Small Business Owner', 'block-theme-scaffold' );
?>
