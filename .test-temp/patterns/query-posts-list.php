...
$read_more_label = esc_html__( 'Continue reading', 'block-theme-scaffold' );
$prev_label      = esc_html__( 'Previous', 'block-theme-scaffold' );
$next_label      = esc_html__( 'Next', 'block-theme-scaffold' );
$no_posts_text   = esc_html__( 'No posts found.', 'block-theme-scaffold' );
?>
