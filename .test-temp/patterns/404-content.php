 ...
 * Slug: block-theme-scaffold/404-content
...
$heading_text     = esc_html__( 'Page Not Found', 'block-theme-scaffold' );
$description_text = esc_html__( 'Sorry, the page you are looking for could not be found. Try searching for it below or browse our recent posts.', 'block-theme-scaffold' );
$search_label     = esc_html__( 'Search', 'block-theme-scaffold' );
$search_placeholder = esc_html__( 'Search the site...', 'block-theme-scaffold' );
$recent_posts_heading = esc_html__( 'Recent Posts', 'block-theme-scaffold' );
$homepage_button_text = esc_html__( 'Go to Homepage', 'block-theme-scaffold' );
$no_posts_text    = esc_html__( 'No posts available.', 'block-theme-scaffold' );
?>
