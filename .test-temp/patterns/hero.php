...
/**
 * Title: Hero Section
 * Slug: block-theme-scaffold/hero
...
$hero_title       = esc_html__( 'Welcome to Our Site', 'block-theme-scaffold' );
$hero_description = esc_html__( 'Discover amazing content and explore what we have to offer. Start your journey today.', 'block-theme-scaffold' );
$primary_button   = esc_html__( 'Get Started', 'block-theme-scaffold' );
$secondary_button = esc_html__( 'Learn More', 'block-theme-scaffold' );
?>
