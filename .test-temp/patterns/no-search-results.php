 ...
 * Slug: block-theme-scaffold/no-search-results
...
$heading_text       = esc_html__( 'Nothing Found', 'block-theme-scaffold' );
$description_text   = esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'block-theme-scaffold' );
$search_label       = esc_html__( 'Search', 'block-theme-scaffold' );
$search_placeholder = esc_html__( 'Search...', 'block-theme-scaffold' );
?>
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)" role="region" aria-label="<?php esc_attr_e( 'No search results', 'block-theme-scaffold' ); ?>">
